/**
 * Example: Anthropic Prompt Caching - User Message
 *
...
async function makeRequest(
  ...
  const response = await fetch(OPENROUTER_API_URL, {
    ...
    headers: {
      ...
      'X-Title': 'Anthropic Cache - User Message',
    },
...
async function main() {
  console.log('╔════════════════════════════════════════════════════════════════════════════╗');
  console.log('║      Anthropic Prompt Caching - User Message with cache_control           ║');
  console.log('╚════════════════════════════════════════════════════════════════════════════╝');
  console.log();
          ...
          content: [
            {
              type: 'text',
              text: largeContext,
              cache_control: { type: 'ephemeral' }, // Cache this content block
            },
            {
              type: 'text',
